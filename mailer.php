...
<div class="container-fluid cFluid">
    ...
    <div id="sanduceslika" class="d-flex justify-content-center"><img src="img/mailbox.png" class="col-1" alt="sanduce">
    </div>
    ...
    <div class="col-12 d-flex   flex-column align-items-center justify-content-center" id="messages">
        ...
        <?php foreach ($result as $r): ?>
            ...
            <div class=" bf-color-replace col-11 col-sm-8  col-lg-6 border border-circle">
                ...
                <div class="div-button  col-12 d-flex justify-content-center"><a
                            href="answer.php?ID=<?php echo $r->MailId; ?>" id="answer">Odgovori</a></div>
            </div>
